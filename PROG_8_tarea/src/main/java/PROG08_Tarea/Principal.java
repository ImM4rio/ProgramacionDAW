...
public class Principal {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Persona Adri = new Persona("Adri", "Otero", "44444444P");
        CuentaAhorro prueba = new CuentaAhorro(Adri, "ES1234567890098765432113", 123142, 1);
        Abarca.abrirCuenta(prueba);   
        ...
        switch (menu) {
            ...
            try{
                ...
                ArrayList <String> cuentas = Abarca.listarCuentas();
                
                if(!cuentas.isEmpty()) {
                    cuentas.forEach(cuenta -> System.out.println(cuenta));
                         
                }else{
                  System.out.println("Todavía no existe ninguna cuenta.");
                }
            ...
            try{
                ...
                //Eliminar una cuenta determinada.
                System.out.println("Introduce el IBAN de la cuenta que quieres eliminar.");
                teclado.nextLine();
                IBAN = teclado.nextLine().toUpperCase();
                
                
                    if(Abarca.eliminarCuentaBancaria(IBAN) && Abarca.traerCuenta(IBAN).getSaldo() == 0){
                        System.out.println("La cuenta se ha eliminado correctamente.");
                        break;
                    }
                    System.out.println("La cuenta no se ha podido eliminar, compruebe los datos introducidos.");
                    break;
                
            }catch (RuntimeException i) {
                System.err.println("Error en la opcion 7.");
            }
            
            case 8:
                try{
                    Abarca.escribirFichero();
                    Abarca.leerFichero();
