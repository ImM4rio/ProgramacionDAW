    ...
    */
    ...
    public Vehiculo (String marca, String matricula, long kms, String fecha, String descripcion, float precio, String propietario, String DNI)
        ...
        if(!comprobarFecha(fecha)){
            ...
            throw new IllegalArgumentException("La fecha tiene que ser anterior a la actual con el formato dd-MM-yyyy.");
        }
            this.fecha = fecha;
        ...
        if(!comprobarMatricula(matricula)) {
            //Si la comprobación de la fecha mediante el método devuelve false.
            throw new IllegalArgumentException("Valor mal introducido, intentelo de nuevo.");
        }
    ...
    @Override
    public int compareTo(Vehiculo nuevo) {
        if (Integer.valueOf(nuevo.getMatricula().substring(0, 4)) > Integer.valueOf(matricula.substring(0, 4))){
            return -1;
            }else if(Integer.valueOf(nuevo.getMatricula().substring(0, 4)) < Integer.valueOf(matricula.substring(0, 4))){
            return 1;
        }
        return 0;
    }
